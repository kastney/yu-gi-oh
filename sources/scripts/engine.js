...
const pathImages = "./sources/assets/icons/";
...
async function createCardImage(IdCard, fieldSide) {
    ...
    cardImage.setAttribute("src", "./sources/assets/icons/card-back.png");
...
async function playAudio(status) {
    const audio = new Audio(`./sources/assets/audios/${status}.wav`);
    try {
        audio.play();
    } catch {}
}
